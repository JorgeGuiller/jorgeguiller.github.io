export const PROJECTS = [
  {
    title: "Project Kurdam",
    description:
      "A world of monsters and myths set in the University of the Philippines Visayas, Project Kurdam is a top-down pixel art action RPG game using Dungeons and Dragons comabt rules.",
    technologies: ["Unity", "C#"],
    link: "#",
    image: "/assets/images/projectkurdam.png",
  },
  {
